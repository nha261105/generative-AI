...
\begin{itemize}
  \item \textbf{Tài liệu đầu vào:} Phiên bản hiện tại tập trung xử lý tài liệu PDF; hỗ trợ DOCX được đưa vào hướng phát triển tiếp theo.
...
\begin{figure}[h]
  \centering
  % \includegraphics[width=\linewidth]{rag_architecture.png}
...
\textbf{Hiện trạng triển khai:} Ở phiên bản hiện tại, luồng upload và xử lý chính vẫn đang tập trung vào PDF. Phần phụ thuộc \texttt{python-docx} đã được chuẩn bị trong môi trường, nhưng chưa có pipeline DOCX độc lập được tích hợp vào giao diện người dùng.

\textbf{Hướng hoàn thiện:}
\begin{itemize}
  \item Bổ sung loader DOCX trong tầng \texttt{application}.
  \item Mở rộng widget upload để nhận cả \texttt{.docx}.
  \item Chuẩn hóa metadata cho DOCX tương tự PDF để tái sử dụng các chain hiện có.
\end{itemize}

\begin{figure}[h]
  \centering
  \IfFileExists{docs/images/module1_docx_placeholder.png}{\includegraphics[width=\linewidth]{docs/images/module1_docx_placeholder.png}}{\fbox{\parbox{0.95\linewidth}{Placeholder ảnh Module 1: docs/images/module1_docx_placeholder.png}}}
  \caption{Minh họa Module 1 - DOCX (placeholder)}
  \label{fig:module1_docx}
\end{figure}
...
\begin{figure}[h]
  \centering
  \IfFileExists{docs/images/module2_history_placeholder.png}{\includegraphics[width=\linewidth]{docs/images/module2_history_placeholder.png}}{\fbox{\parbox{0.95\linewidth}{Placeholder ảnh Module 2: docs/images/module2_history_placeholder.png}}}
  \caption{Minh họa Module 2 - Lưu trữ lịch sử hội thoại (placeholder)}
  \label{fig:module2_history}
\end{figure}
...
\begin{figure}[h]
  \centering
  \IfFileExists{docs/images/module3_state_placeholder.png}{\includegraphics[width=\linewidth]{docs/images/module3_state_placeholder.png}}{\fbox{\parbox{0.95\linewidth}{Placeholder ảnh Module 3: docs/images/module3_state_placeholder.png}}}
  \caption{Minh họa Module 3 - Quản lý trạng thái hệ thống (placeholder)}
  \label{fig:module3_state}
\end{figure}
...
\begin{figure}[h]
  \centering
  \IfFileExists{docs/images/module4_chunk_placeholder.png}{\includegraphics[width=\linewidth]{docs/images/module4_chunk_placeholder.png}}{\fbox{\parbox{0.95\linewidth}{Placeholder ảnh Module 4: docs/images/module4_chunk_placeholder.png}}}
  \caption{Minh họa Module 4 - Tùy chỉnh chiến lược phân đoạn (placeholder)}
...
\begin{figure}[h]
  \centering
  \IfFileExists{docs/images/module5_citation_placeholder.png}{\includegraphics[width=\linewidth]{docs/images/module5_citation_placeholder.png}}{\fbox{\parbox{0.95\linewidth}{Placeholder ảnh Module 5: docs/images/module5_citation_placeholder.png}}}
...
\textbf{Triển khai hiện tại:}
\begin{itemize}
  \item Lịch sử hội thoại gần nhất được format và chèn vào prompt trước khi gọi LLM.
  \item Cơ chế này cho phép mô hình hiểu câu hỏi follow-up dựa trên ngữ cảnh trước đó.
\end{itemize}

\textbf{Giới hạn hiện tại:} Chưa có memory chain độc lập hoặc cơ chế tóm tắt lịch sử dài; phạm vi ngữ cảnh còn phụ thuộc số lượt chat gần nhất.

\begin{figure}[h]
  \centering
  \IfFileExists{docs/images/module6_conversational_placeholder.png}{\includegraphics[width=\linewidth]{docs/images/module6_conversational_placeholder.png}}{\fbox{\parbox{0.95\linewidth}{Placeholder ảnh Module 6: docs/images/module6_conversational_placeholder.png}}}
...
\begin{figure}[h]
  \centering
  \IfFileExists{docs/images/module7_hybrid_placeholder.png}{\includegraphics[width=\linewidth]{docs/images/module7_hybrid_placeholder.png}}{\fbox{\parbox{0.95\linewidth}{Placeholder ảnh Module 7: docs/images/module7_hybrid_placeholder.png}}}
  \caption{Minh họa Module 7 - Hybrid Search (placeholder)}
...
\begin{figure}[h]
  \centering
  \IfFileExists{docs/images/module8_multidoc_placeholder.png}{\includegraphics[width=\linewidth]{docs/images/module8_multidoc_placeholder.png}}{\fbox{\parbox{0.95\linewidth}{Placeholder ảnh Module 8: docs/images/module8_multidoc_placeholder.png}}}
...
\begin{figure}[h]
  \centering
  \IfFileExists{docs/images/module9_rerank_placeholder.png}{\includegraphics[width=\linewidth]{docs/images/module9_rerank_placeholder.png}}{\fbox{\parbox{0.95\linewidth}{Placeholder ảnh Module 9: docs/images/module9_rerank_placeholder.png}}}
...
\begin{figure}[h]
  \centering
  \IfFileExists{docs/images/module10_selfrag_placeholder.png}{\includegraphics[width=\linewidth]{docs/images/module10_selfrag_placeholder.png}}{\fbox{\parbox{0.95\linewidth}{Placeholder ảnh Module 10: docs/images/module10_selfrag_placeholder.png}}}
